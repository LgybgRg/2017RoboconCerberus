    ...
    */
    void Set4WheelPower(int16_t Power[]) {
      ...
      if (r < BorderValue) {
        ...
        //タイヤの設置角度
        Power[0] = r * sin(m_angle - (PI / 4));
        Power[1] = r * sin(m_angle - (3 * PI / 4));
        Power[2] = r * sin(m_angle - (5 * PI / 4));
        Power[3] = r * sin(m_angle - (7 * PI / 4));
      }
    ...
    void Set4WheelPower(int16_t Power[], int gyro_deg) {
      ...
      if (r < BorderValue) {
        ...
        //タイヤの設置角度
        Power[0] = r * sin(m_angle - (PI / 4) + radians(gyro_deg));
        Power[1] = r * sin(m_angle - (3 * PI / 4) + radians(gyro_deg));
        Power[2] = r * sin(m_angle - (5 * PI / 4) + radians(gyro_deg));
        Power[3] = r * sin(m_angle - (7 * PI / 4) + radians(gyro_deg));
      }
