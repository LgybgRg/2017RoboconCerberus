...
class ControllerManager {
  ...
  private:
    ...
    bool up_count;
    byte start_count;
    bool circle_count, tri_count, square_count, cross_count, share_tri;
  ...
  public:
    ...
    void Update() {
      ...
      uint8_t buf[] = { 0, 0, 127, 127, 127, 127, 0, 0, 0, 0};
      ...
      PS = bitRead(buf[8], 0);
      up_count = bitRead(buf[8], 1);
      circle_count = bitRead(buf[8], 2);
      cross_count = bitRead(buf[8], 3);
      square_count = bitRead(buf[8], 4);
      tri_count = bitRead(buf[8], 5);
      share_tri = bitRead(buf[8], 6);
      Touch = bitRead(buf[8], 7);
