...
uint8_t PAD_DATA[] = {0, 0, 127, 127, 127, 127, 0, 0, 0, 0};
static byte startcount, upcount, share_tri;
static byte circle_count, cross_count, square_count, tri_count;
...
void loop() {
  uint8_t PS4_DATA[] = {0, 0, 127, 127, 127, 127, 0, 0, 0, 0};
  ...
  Serial.print("\t");
  Serial.print(PS4_DATA[7]);
  Serial.print("\t");
  Serial.print(PS4_DATA[8]);
  Serial.print("\t");
  Serial.println(PS4_DATA[9]);
#endif
...
void BTControlGet(uint8_t data[])
{
  ...
  if (PS4.connected()) {
    ...
    if (PS4.getButtonClick(PS)) {
      ...
      //bitWrite(data[0], 3, PS4.getButtonClick(START));
      ...
      */
      ...
      /*
        ...
        bitWrite(data[1], 7, PS4.getButtonClick(SQUARE));
      ...
      */
      ...
      bitWrite(data[8], 0, PS4.getButtonPress(PS));
      bitWrite(data[8], 1, upcount % 2);
      bitWrite(data[8], 2, circle_count % 2);
      bitWrite(data[8], 3, cross_count % 2);
      bitWrite(data[8], 4, square_count % 2);
      bitWrite(data[8], 5, tri_count % 2);
      bitWrite(data[8], 6, share_tri % 2);
      //bitWrite(data[8],7,PS4.isTouching());
      data[9] = startcount % 4;
      ...
      if (startcount % 4 == 0)
        PS4.setLed(Blue);
      else if (startcount % 4 == 1)
        PS4.setLed(Green);
      else if (startcount % 4 == 2)
        PS4.setLed(Red);
      else
        PS4.setLed(Yellow);
    }
