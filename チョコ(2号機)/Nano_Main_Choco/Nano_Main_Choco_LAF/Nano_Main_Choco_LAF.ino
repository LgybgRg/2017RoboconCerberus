...
i2cMasterWriter Arm(1, 4), Solenoid(3, 5), Mecanum(2, 6, MECANUM), EDF(4, 1);
...
static PidController pidJoint(2.0, 0, 0, loopArm.Cycle_us(), 300.0);
...
void Tire() {
  ...
  Mecanum.SetSingleData(5, DS4.GetStartToggle());  //反転モード
}
