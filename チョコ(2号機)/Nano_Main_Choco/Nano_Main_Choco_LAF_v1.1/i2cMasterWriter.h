...
class i2cMasterWriter {
  ...
  public:
    ...
    */
    ...
    /*
          新モタドのデータ送信用関数(ロックアンチフェーズ)
          @param   portNum : ポート番号(1～4)
          @param   PWM     : PWM値 ※ 127 ブレーキ / 255 正転 / 0 逆転
    */
    void toG2MotorDriverLAP(int portNum,int16_t PWM) {
      data[portNum - 1] = PWM;
    }
